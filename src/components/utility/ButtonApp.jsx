...
export const ButtonApp = ({ content, type, appearance, isLoading, className, icon, onClick, disabled, size }) => {
    ...
    const sizes = {
        sm: "!px-4 !py-1.5 [&>p]:text-xs",
        md: "!px-6 !py-2 [&>p]:text-sm",
        lg: "!px-8 !py-3 [&>p]:text-base",
    };
    ...
    return (
        <button
            ...
            className={ `
                ...
                ${appearances[appearance]} ${ disabledStyles } ${ iconClasses } ${ className } ${ sizes[size] }
            ` }
            ...
            <p className="relative z-20 flex items-center text-sm">
